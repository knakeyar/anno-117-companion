        ...
        assert opportunities["items"] == [
            {
                ...
                "advisory_amount": 5.0,
                "source_available_stock": 85.0,
                "source_high_target": 80.0,
                "projected_source_stock": 80.0,
                "destination_available_stock": 5.0,
                "destination_low_target": 25.0,
                "projected_destination_stock": 10.0,
